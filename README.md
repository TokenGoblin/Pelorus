...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,222 | 3,926 | 1,056 |
| Rust — tests | 23 | 4,114 | 1,336 | 624 |
| Rust — fuzz targets | 9 | 173 | 123 | 32 |
| CI scripts | 23 | 1,495 | 829 | 307 |
| **Total** | **100** | **13,004** | **6,214** | **2,019** |

Plus 7,129 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `2e8b41b`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
