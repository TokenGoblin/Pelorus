...
| Rust — tests | 23 | 4,030 | 1,315 | 618 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,460 | 784 | 299 |
| **Total** | **98** | **12,686** | **5,924** | **1,980** |

Plus 6,726 lines of specification and decision records across 33 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `bc8bf4a`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
