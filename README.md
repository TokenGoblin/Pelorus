...
Plus 5,408 lines of specification and decision records across 28 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `dfbfd70`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
