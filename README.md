...
| CI scripts | 21 | 1,340 | 596 | 273 |
| **Total** | **75** | **8,199** | **3,676** | **1,300** |

Plus 5,421 lines of specification and decision records across 28 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `12995b5`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
