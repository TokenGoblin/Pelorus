...
| CI scripts | 17 | 995 | 411 | 201 |
| **Total** | **49** | **4,030** | **1,981** | **678** |

Plus 4,484 lines of specification and decision records across 22 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `35c4184`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
