...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,028 | 3,711 | 1,034 |
| Rust — tests | 22 | 3,920 | 1,269 | 599 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,460 | 784 | 299 |
| **Total** | **97** | **12,576** | **5,878** | **1,961** |

Plus 6,681 lines of specification and decision records across 33 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `c2bdc0f`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
