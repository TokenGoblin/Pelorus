...
| Rust — tests | 23 | 4,234 | 1,386 | 639 |
| Rust — fuzz targets | 9 | 173 | 123 | 32 |
| CI scripts | 23 | 1,503 | 841 | 307 |
| **Total** | **100** | **13,164** | **6,309** | **2,035** |

Plus 7,177 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `fd12acc`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
