...
|---|---:|---:|---:|---:|
| Rust — crate sources | 43 | 6,707 | 3,341 | 979 |
| Rust — tests | 20 | 3,280 | 1,116 | 494 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,448 | 764 | 298 |
| **Total** | **93** | **11,603** | **5,335** | **1,800** |

Plus 6,351 lines of specification and decision records across 32 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `d404156`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
