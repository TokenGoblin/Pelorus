...
Plus 4,514 lines of specification and decision records across 22 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `0e65455`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
