...
|---|---:|---:|---:|---:|
| Rust — crate sources | 34 | 4,327 | 2,198 | 651 |
| Rust — tests | 10 | 1,391 | 440 | 208 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 21 | 1,327 | 572 | 271 |
| **Total** | **71** | **7,203** | **3,308** | **1,153** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `55619fc`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
