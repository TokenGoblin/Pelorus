...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,253 | 3,944 | 1,057 |
| Rust — tests | 24 | 4,187 | 1,363 | 634 |
| Rust — fuzz targets | 9 | 173 | 123 | 32 |
| CI scripts | 23 | 1,495 | 829 | 307 |
| **Total** | **101** | **13,108** | **6,259** | **2,030** |

Plus 7,157 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `8c9b34e`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
