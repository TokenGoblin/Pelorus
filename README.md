...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,254 | 3,959 | 1,057 |
| Rust — tests | 23 | 4,263 | 1,397 | 642 |
| Rust — fuzz targets | 9 | 173 | 123 | 32 |
| CI scripts | 23 | 1,503 | 841 | 307 |
| **Total** | **100** | **13,193** | **6,320** | **2,038** |

Plus 7,177 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `57db70c`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
