...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 6,955 | 3,640 | 1,022 |
| Rust — tests | 22 | 3,894 | 1,255 | 594 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,460 | 784 | 299 |
| **Total** | **97** | **12,477** | **5,793** | **1,944** |

Plus 6,462 lines of specification and decision records across 32 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `18f5e2f`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
