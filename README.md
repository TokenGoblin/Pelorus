...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,009 | 3,664 | 1,030 |
| Rust — tests | 22 | 3,920 | 1,269 | 599 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,460 | 784 | 299 |
| **Total** | **97** | **12,557** | **5,831** | **1,957** |

Plus 6,498 lines of specification and decision records across 32 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `8ef7d8d`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
