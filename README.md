...
|---|---:|---:|---:|---:|
| Rust — crate sources | 45 | 7,083 | 3,770 | 1,044 |
| Rust — tests | 23 | 4,057 | 1,323 | 621 |
| Rust — fuzz targets | 9 | 173 | 123 | 32 |
| CI scripts | 23 | 1,495 | 829 | 307 |
| **Total** | **100** | **12,808** | **6,045** | **2,004** |

Plus 7,005 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `ff881f5`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
