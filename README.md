...
|---|---:|---:|---:|---:|
| Rust — crate sources | 33 | 3,994 | 2,093 | 610 |
| Rust — tests | 10 | 1,391 | 440 | 208 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 21 | 1,327 | 572 | 271 |
| **Total** | **70** | **6,870** | **3,203** | **1,112** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `7d596b9`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
