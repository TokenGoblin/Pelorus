...
|---|---:|---:|---:|---:|
| Rust — crate sources | 31 | 3,642 | 1,936 | 555 |
| Rust — tests | 8 | 1,143 | 379 | 178 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 20 | 1,250 | 523 | 251 |
| **Total** | **65** | **6,193** | **2,936** | **1,007** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `aa2d200`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
