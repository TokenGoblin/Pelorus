...
|---|---:|---:|---:|---:|
| Rust — crate sources | 32 | 3,848 | 2,029 | 583 |
| Rust — tests | 9 | 1,195 | 410 | 185 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 20 | 1,250 | 523 | 251 |
| **Total** | **67** | **6,451** | **3,060** | **1,042** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `50f7dba`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
