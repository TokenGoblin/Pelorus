...
| CI scripts | 22 | 1,461 | 794 | 299 |
| **Total** | **98** | **12,769** | **6,001** | **1,993** |

Plus 6,891 lines of specification and decision records across 34 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `f3c03cf`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
