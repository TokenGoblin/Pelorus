...
|---|---:|---:|---:|---:|
| Rust — crate sources | 27 | 3,249 | 1,642 | 485 |
| Rust — tests | 4 | 504 | 199 | 94 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 19 | 1,131 | 514 | 231 |
| **Total** | **56** | **5,042** | **2,453** | **833** |

Plus 5,000 lines of specification and decision records across 26 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `4186cef`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
