...
|---|---:|---:|---:|---:|
| Rust — crate sources | 41 | 5,823 | 2,920 | 870 |
| Rust — tests | 17 | 2,536 | 867 | 413 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 22 | 1,440 | 731 | 297 |
| **Total** | **86** | **9,957** | **4,616** | **1,603** |

Plus 5,944 lines of specification and decision records across 30 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `0dbac50`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
