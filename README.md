...
|---|---:|---:|---:|---:|
| Rust — crate sources | 37 | 5,091 | 2,503 | 759 |
| Rust — tests | 11 | 1,610 | 479 | 245 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 21 | 1,333 | 584 | 272 |
| **Total** | **75** | **8,192** | **3,664** | **1,299** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `2010e17`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
