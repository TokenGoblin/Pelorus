...
|---|---:|---:|---:|---:|
| Rust — crate sources | 25 | 2,630 | 1,395 | 399 |
| Rust — tests | 3 | 281 | 134 | 63 |
| Rust — fuzz targets | 4 | 125 | 55 | 16 |
| CI scripts | 18 | 1,080 | 479 | 218 |
| **Total** | **50** | **4,116** | **2,063** | **696** |

Plus 5,000 lines of specification and decision records across 26 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `29a5d2b`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
