...
Plus 4,742 lines of specification and decision records across 24 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `8a7a9c3`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
