...
| Rust — tests | 19 | 2,851 | 969 | 449 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,440 | 731 | 297 |
| **Total** | **92** | **11,022** | **5,063** | **1,737** |

Plus 5,969 lines of specification and decision records across 30 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `7ee55f9`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
