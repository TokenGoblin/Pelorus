...
|---|---:|---:|---:|---:|
| Rust — crate sources | 35 | 4,593 | 2,304 | 683 |
| Rust — tests | 11 | 1,610 | 479 | 245 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 21 | 1,327 | 572 | 271 |
| **Total** | **73** | **7,688** | **3,453** | **1,222** |

Plus 5,189 lines of specification and decision records across 27 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `395005e`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
