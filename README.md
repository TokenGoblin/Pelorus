...
Generated by `ci/count-lines.sh`, last run against the tree at `d84b1cb`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
