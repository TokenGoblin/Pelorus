...
|---|---:|---:|---:|---:|
| Rust — crate sources | 43 | 6,563 | 3,249 | 962 |
| Rust — tests | 20 | 3,272 | 1,108 | 492 |
| Rust — fuzz targets | 8 | 168 | 114 | 29 |
| CI scripts | 22 | 1,446 | 741 | 298 |
| **Total** | **93** | **11,449** | **5,212** | **1,781** |

Plus 6,014 lines of specification and decision records across 30 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `6111eb2`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
