...
Plus 7,036 lines of specification and decision records across 35 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `f063eee`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
