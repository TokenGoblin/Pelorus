...
| CI scripts | 22 | 1,435 | 692 | 293 |
| **Total** | **77** | **8,574** | **3,894** | **1,367** |

Plus 5,546 lines of specification and decision records across 28 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `681e837`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
