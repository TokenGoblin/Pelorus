...
|---|---:|---:|---:|---:|
| Rust — crate sources | 37 | 5,097 | 2,510 | 760 |
| Rust — tests | 12 | 1,739 | 538 | 272 |
| Rust — fuzz targets | 6 | 158 | 98 | 23 |
| CI scripts | 21 | 1,340 | 617 | 274 |
| **Total** | **76** | **8,334** | **3,763** | **1,329** |

Plus 5,437 lines of specification and decision records across 28 documents.

Generated by `ci/count-lines.sh`, last run against the tree at `3aa1b33`. Regenerate rather than edit — a number nobody measured is the kind this project keeps getting wrong. `ci/count-lines.sh --check` reports whether this is stale.
